...
const SAFE_CODES = new Set([
  ...
  "RATE_LIMITED",
  "BOT_STOOD_DOWN",
  // Feature 8b — PLATFORM_LIMITS violation codes
  "ALLOCATION_EXCEEDS_PLATFORM_CEILING",
  "DAILY_LOSS_BELOW_PLATFORM_FLOOR",
  "SIGNAL_WEIGHTS_INVALID_TOTAL",
  "WATCHLIST_EXCEEDS_MAX",
  "EXCLUSION_LIST_EXCEEDS_MAX",
  "WATCHLIST_EXCLUSION_OVERLAP",
  "ALL_DAYS_AVOIDED",
  "AGENT_BACKGROUND_EXCEEDS_MAX",
]);
